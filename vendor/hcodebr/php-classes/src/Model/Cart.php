...
class Cart extends Model {
  ...
  const SESSION_ERROR = "CartError";
    ...
    public function getFromSessionID()
    {
        ...
        $results = $sql->select("SELECT * FROM tb_carts WHERE idessessionid = :idessessionid", [
          ':idessessionid'=>session_id()
        ]);
    ...
    public function setFreight($nrzipcode)
    {
      ...
      if($totals['nrqtd'] > 0){
        ...
        $xml = simplexml_load_file("http://ws.correios.com.br/calculador/CalcPrecoPrazo.asmx/CalcPrecoPrazo?".$sql);
